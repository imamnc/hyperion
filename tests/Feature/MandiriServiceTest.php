...
class MandiriServiceTest extends TestCase
{
    /*==========================================================================
     LOGIN
    ==========================================================================*/
     ...
     * @return void
     */
    public function test_mdri_login_success()
    {
        // Make request data
        $request = [
            'project' => 'mdri',
            'email' => env('MDRI_USERNAME'),
            'password' => env('MDRI_PASSWORD')
        ];
        // Http request
     ...
     * @return void
     */
    public function test_mdri_login_with_invalid_payload()
    {
     ...
     * @return void
     */
    public function test_mdri_login_with_no_accept_json_header()
    {
     ...
     * @group mdri
     * @group mdri.user_detail
     * @return void
     */
    public function test_mdri_get_user_detail()
    {
        // Http request
     ...
     * @return void
     */
    public function test_mdri_get_user_detail_with_no_accept_json_header()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_user_detail_without_token()
    {
        // Http request with no Accept header (application/json)
     ...
     * @group mdri
     * @group mdri.vendor_list
     * @return void
     */
    public function test_mdri_get_vendor_list()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_vendor_list_with_invalid_payload()
    {
        // Http request login
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_vendor_list_with_no_accept_json_header()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_vendor_list_without_token()
    {
        // Http request with no Accept header (application/json)
        $response = $this->withHeader('Accept', 'application/json')
            ->get('/api/vendor?' . http_build_query([
     ...
     * @group mdri
     * @group mdri.blacklist
     * @return void
     */
    public function test_mdri_get_blacklist()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_blacklist_with_invalid_payload()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_blacklist_with_no_accept_json_header()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_blacklist_without_token()
    {
        // Http request with no Accept header (application/json)
        $response = $this->withHeader('Accept', 'application/json')
            ->get('/api/vendor/blacklist?' . http_build_query([
     ...
     * @group mdri
     * @group mdri.pengadaan_list
     * @return void
     */
    public function test_mdri_get_pengadaan_list()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_pengadaan_list_with_invalid_payload()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_pengadaan_list_with_no_accept_json_header()
    {
        // Http request
        $response_login = $this->withHeader('Accept', 'application/json')->post('/api/login', [
            'project' => 'mdri',
     ...
     * @return void
     */
    public function test_mdri_get_pengadaan_list_without_token()
    {
        // Make request data
        $request = [
            'keyword' => null, // nullable|string
